...
export default function VerifyOtp() {
  ...
  const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:5000/api/customers/forgot/verify-otp", {
            method: "POST",
  ...
  const handleResend = async () => {
    ...
    setMessage("");
    try {
      const response = await fetch("http://localhost:5000/api/customers/forgot/send-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
